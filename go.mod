module bsc.es/colmena/local-torrent
...
require (
	...
	github.com/philrhc/zyre v0.0.0-20241004075044-66f64cd809a5
)
...
replace github.com/anacrolix/torrent => github.com/philrhc/torrent v0.0.0-20250310124924-966d14b5019a
